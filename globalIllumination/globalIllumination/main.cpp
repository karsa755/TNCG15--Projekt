...
polyModel createScene()
{
	...
	//wall 1, red
	sceneList.push_back(triangle(roofVertices[1], floorVertices[1], floorVertices[2], color(0.5, 0.5, 0.5)));
	sceneList.push_back(triangle(floorVertices[2], roofVertices[2], roofVertices[1], color(0.5, 0.5, 0.5)));
	//wall 2, blue
	sceneList.push_back(triangle(floorVertices[5], floorVertices[2], roofVertices[5], color(0.5, 0.5, 0.5)));
	sceneList.push_back(triangle(roofVertices[2], roofVertices[5], floorVertices[2], color(0.5, 0.5, 0.5)));
	//wall 3, green
	sceneList.push_back(triangle(floorVertices[5], roofVertices[5], roofVertices[4], color(0.5, 0.5, 0.5)));
	sceneList.push_back(triangle(roofVertices[4], floorVertices[4], floorVertices[5], color(0.5, 0.5, 0.5)));
	//wall 4
	sceneList.push_back(triangle(roofVertices[4], floorVertices[3], floorVertices[4], color(0.5, 0.5, 0.5)));
	sceneList.push_back(triangle(roofVertices[3], floorVertices[3], roofVertices[4], color(0.5, 0.5, 0.5)));
	//wall 5
	sceneList.push_back(triangle(roofVertices[0], floorVertices[0], floorVertices[3], color(0.5, 0.5, 0.5)));
	sceneList.push_back(triangle(roofVertices[0], floorVertices[3], roofVertices[3], color(0.5, 0.5, 0.5)));
	glm::vec3 n = (sceneList.back()).getNormal();
	std::cout << "(" << n.x << "," << n.y << "," << n.z << ")" << std::endl;
	//wall 6
	sceneList.push_back(triangle(roofVertices[0], floorVertices[1], floorVertices[0], color(0.5, 0.5, 0.5)));
	sceneList.push_back(triangle(roofVertices[1], floorVertices[1], roofVertices[0], color(0.5, 0.5, 0.5)));
...
polyModel createTetra()
{
	vertex tetraVerts[4];
	std::vector<triangle> sceneList;
	tetraVerts[0] = vertex(4.0f, -0.3f, 0.0f, 1.0f);
	tetraVerts[1] = vertex(5.0f, -0.75f, 0.0f, 1.0f);
	tetraVerts[2] = vertex(4.0f, -1.0f, 0.0f, 1.0f);
	tetraVerts[3] = vertex(5.0f, -0.75f, 1.0f, 1.0f);
...
int main(int, char*[])
{
	...
	//implicitModel sphere(0.4f, glm::vec3(1.0f, 0.3f, 0.0f), MIRROR);
	implicitModel sphere(1.0f, glm::vec3(5.0f, 0.0f, 0.0f), MIRROR,color(1.0,1.0,1.0));
